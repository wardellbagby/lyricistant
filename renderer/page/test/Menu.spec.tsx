...
jest.mock('@renderer/stores/EditorTextStore', () => ({
  useEditorText: jest.fn(),
}));
jest.mock('react-router-dom', () => ({ useHistory: jest.fn() }));
jest.mock('@renderer/util/download-app', () => ({ downloadApp: jest.fn() }));

describe('Menu component', () => {
  beforeEach(() => {
    platformDelegate = jest.requireMock('@renderer/globals').platformDelegate;
    mockUseEditorText = jest.requireMock('@renderer/stores/EditorTextStore')
      .useEditorText;
    mockUseHistory = jest.requireMock('react-router-dom').useHistory;
    mockDownloadApp = jest.requireMock('@renderer/util/download-app').downloadApp;
