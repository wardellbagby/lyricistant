 ...
 * the tree that uses the platform delegate, so that the app properly alerts
 * the platform that it is ready to receive events after every other component
 * has registered its own platform listeners.
 */
